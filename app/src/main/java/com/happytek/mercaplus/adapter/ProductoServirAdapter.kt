...
class ProductoServirAdapter (val lista : ArrayList<Producto>, val onItemClickValue : RecyclerViewClickListener ) : RecyclerView.Adapter<ProductoServirAdapter.MuroViewHolder>() {
    ...
    /*    holder.itemView.setOnClickListener(){
        ...
        holder.itemView.setOnClickListener() {
            var intent = Intent(holder.itemView.context, ServirProductoCantidadActivity::class.java)
